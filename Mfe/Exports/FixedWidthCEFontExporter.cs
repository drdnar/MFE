...
{
    [FontExporter]
    public class FixedWidthCEFontExporter
    {
        [FontExporter(FileTypeExtension = "asm", FileTypeDescription = "Fixed Width CE Font", HelpText = "Exports to an assembly source code file for #inclusion.")]
