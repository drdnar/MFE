...
{
    [FontExporter]
    public class MateoCEFontExporter
    {
        [FontExporter(FileTypeExtension = "asm", FileTypeDescription = "Mateo's Variable Width CE Font Format", HelpText = "Exports to an assembly source code file for #inclusion.")]
        public static void ExportData(Mfe.Font font, string path)
        {
            ...
            string MonoFlag = font["MonoFlag"] ?? "MonoFlag_ASM";
            string CharSpacing = font["CharSpacing"] ?? "CharSpacing_ASM";
            string TextData = font["TextData"] ?? "TextData_ASM";
            string DefaultCharSpacing = font["DefaultCharSpacing"] ?? "DefaultCharSpacing_ASM";
            string DefaultTextData = font["DefaultTextData"] ?? "DefaultTextData_ASM";
            int firstChar;
            int lastChar;
